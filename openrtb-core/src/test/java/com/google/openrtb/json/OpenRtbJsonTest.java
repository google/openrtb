...
public class OpenRtbJsonTest
{
   ...
   public void testRequest_emptyMessages() throws IOException
   {
      ...
      testRequest(jsonFactory, BidRequest.newBuilder()
                                         ...
                                         .setUser(User.newBuilder()
                                                      .addData(Data.newBuilder().addSegment(Segment.newBuilder())))
                                         .build());
      testRequest(jsonFactory, BidRequest.newBuilder()
                                         .setId("0")
                                         .setSite(Site.newBuilder()
                                                      .setContent(
                                                         Content.newBuilder().setProducer(Producer.newBuilder())))
                                         .build());
   }
                                                                   ...
                                                                   .addAssets(NativeRequest.Asset.newBuilder()
                                                                                                 ...
                                                                                                 .setImg(
                                                                                                    NativeRequest.Asset.Image
                                                                                                       .newBuilder()
                                                                                                       .setType(
                                                                                                          NativeRequest.Asset.Image.ImageAssetType.MAIN)
                                                                                                       .setWmin(350)
                                                                                                       .setHmin(350)))
                                                                   .addAssets(NativeRequest.Asset.newBuilder()
                                                                                                 .setId(3)
                                                                                                 ...
                                                                                                 .setData(
                                                                                                    NativeRequest.Asset.Data
                                                                                                       .newBuilder()
                                                                                                       .setType(
                                                                                                          NativeRequest.Asset.Data.DataAssetType.DESC)
                                                                                                       .setLen(90)))
                                                                   .addAssets(NativeRequest.Asset.newBuilder()
                                                                                                 .setId(4)
                                                                                                 .setRequired(false)
                                                                                                 .setData(
                                                                                                    NativeRequest.Asset.Data
                                                                                                       .newBuilder()
                                                                                                       .setType(
                                                                                                          NativeRequest.Asset.Data.DataAssetType.CTATEXT)
                                                                                                       .setLen(25)))
                                                                   .addAssets(
                                                                      NativeRequest.Asset.newBuilder().setId(5));
   ...
   public void testRequest_extBug() throws IOException
   {
      ...
      BidRequest req = BidRequest.newBuilder().setId("0").build();
      // Based on Issue #34
      assertThat(reader.readBidRequest("{ \"ext\": { \"x\": 0, \"y\": {} }, \"id\": \"0\" }")).isEqualTo(req);
   }
   ...
   public void testResponse() throws IOException
   {
      ...
      assertThat(jsonFactory.newWriter().writeBidResponse(newBidResponse(false).build())).isEqualTo(jsonResp);
   }
   ...
   {
      testResponseWithNative(OpenRtbJsonResponseHelper.RESPONSE_SHORT_NOROOT_STRING);
      testResponseWithNative(OpenRtbJsonResponseHelper.RESPONSE_SHORT_NOROOT_OBJECT);
      testResponseWithNative(OpenRtbJsonResponseHelper.RESPONSE_SHORT_ROOT___STRING);
      testResponseWithNative(OpenRtbJsonResponseHelper.RESPONSE_SHORT_ROOT___OBJECT);

      testResponseWithNative(OpenRtbJsonResponseHelper.RESPONSE_FULL__NOROOT_STRING);
      testResponseWithNative(OpenRtbJsonResponseHelper.RESPONSE_FULL__NOROOT_OBJECT);
      testResponseWithNative(OpenRtbJsonResponseHelper.RESPONSE_FULL__ROOT___STRING);
      testResponseWithNative(OpenRtbJsonResponseHelper.RESPONSE_FULL__ROOT___OBJECT);
   }
   ...
   {
      OpenRtbJsonFactory jsonFactory = newJsonFactory();
      testResponse(jsonFactory, BidResponse.newBuilder().setId("0").setExtension(TestExt.testResponse1, test1).build());
   }
   ...
   {
      OpenRtbJsonFactory jsonFactory = newJsonFactory();
      testResponse(jsonFactory, BidResponse.newBuilder().setId("0").setExtension(TestExt.testResponse3, 99).build());
   }
   ...
   {
      OpenRtbJsonFactory jsonFactory = newJsonFactory();
      testRequest(jsonFactory, BidRequest.newBuilder().setId("0").setExtension(TestExt.testRequest2, test2).build());
   }
   ...
   public void testExt2Double() throws IOException
   {
      ...
      testResponse(jsonFactory, BidResponse.newBuilder()
                                           .setId("0")
                                           .setExtension(TestExt.testResponse2A,
                                                         Test2.newBuilder().setTest2("data2a").build())
                                           .setExtension(TestExt.testResponse2B,
                                                         Test2.newBuilder().setTest2("data2b").build())
                                           .build());
   }
   ...
   public void testResponse_emptyMessages() throws IOException
   {
      ...
      testResponse(jsonFactory, BidResponse.newBuilder().setId("1").addSeatbid(SeatBid.newBuilder()).build());
      testResponse(jsonFactory, BidResponse.newBuilder()
                                           .setId("1")
                                           .addSeatbid(SeatBid.newBuilder()
                                                              .addBid(
                                                                 Bid.newBuilder().setId("0").setImpid("0").setPrice(0)))
                                           .build());
   }
   ...
   {
      String test = "{ \"id\": \"0\", " + "\"x1\": 10, \"at\": 1, " + "\"x2\": \"x\", \"x3\": [4], \"test\": 1, " +
                    "\"x4\": { \"x5\": [] }, \"tmax\": 100, " +
                    "\"ext\": { \"x6\": [ { \"x7\": 100, \"x8\": 3.1415 } ], \"test1\": \"*\" }" + "}";
      assertThat(newJsonFactory().newReader().readBidRequest(test)).isEqualTo(BidRequest.newBuilder()
                                                                                        .setId("0")
                                                                                        .setAt(AuctionType.FIRST_PRICE)
                                                                                        .setTest(true)
                                                                                        .setTmax(100)
                                                                                        .setExtension(
                                                                                           TestExt.testRequest1,
                                                                                           Test1.newBuilder()
                                                                                                .setTest1("*")
                                                                                                .build())
                                                                                        .build());
      ...
      return BidRequest.newBuilder()
                       ...
                       .addImp(Imp.newBuilder()
                                  ...
                                  .setVideo(Video.newBuilder()
                                                 ...
                                                 .setPos(AdPosition.ABOVE_THE_FOLD)
                                                 .addCompanionad(
                                                    Banner.newBuilder().setId("compad1").setW(100).setH(50))
                       ...
                       .addBadv("badguy")
                       .setRegs(Regs.newBuilder().setCoppa(true).setExtension(TestExt.testRegs, test1))
                       .setTest(false)
   ...
   static BidResponse.Builder newBidResponse(boolean admNative)
   {
      ...
      if(admNative)
      {
         bid.setAdmNative(NativeResponse.newBuilder().setVer("1.0").setLink(NativeResponse.Link.newBuilder()));
      }
      else
      {
