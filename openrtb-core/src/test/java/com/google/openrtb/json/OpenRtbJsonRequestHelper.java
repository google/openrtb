...
class OpenRtbJsonRequestHelper
{
   ...
   static final String REQUEST__SHORT_ROOT___OBJECT =
      ...
      "\"name\":\"my-app-name\",\"domain\":\"mysite.foo.com\",\"paid\":1,\"keywords\":\"my,app,key,words\"},\"device\":{" +
      "\"ua\":\"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36\"," +
      "\"geo\":{\"city\":\"New York\"},\"dnt\":0,\"lmt\":1,\"ip\":\"192.168.1.0\",\"ipv6\":\"1:2:3:4:5:6:0:0\"}," +
      "\"user\":{\"id\":\"user1\",\"buyeruid\":\"buyer1\",\"gender\":\"O\",\"keywords\":\"user,builder,key,words\"," +
      "\"geo\":{\"city\":\"New York\"}}}";
   ...
   static final String REQUEST__FULL__NOROOT_STRING =
      "{\"id\":\"9zj61whbdl319sjgz098lpys5cngmtro_full_false_false\",\"imp\":[{\"id\":\"imp1\",\"banner\":{\"wmax\":300," +
      "\"hmax\":100,\"wmin\":200,\"hmin\":50,\"id\":\"banner1\",\"btype\":[3],\"battr\":[12],\"pos\":1," +
   ...
   static final String REQUEST__FULL__NOROOT_OBJECT =
      ...
      "\"ext\":{\"test1\":\"data1\"}}],\"ext\":{\"test1\":\"data1\"}},\"test\":0,\"at\":2,\"tmax\":100," +
      "\"wseat\":[\"seat1\"],\"allimps\":0,\"cur\":[\"USD\"],\"bcat\":[\"IAB11\",\"IAB11-4\"],\"badv\":[\"badguy\"]," +
      "\"regs\":{\"coppa\":1,\"ext\":{\"test1\":\"data1\"}},\"ext\":{\"test1\":\"data1\",\"test2ext\":{" +
      "\"test2\":\"data2\"}}}";
   ...
   static final String REQUEST__FULL__ROOT___STRING =
      "{\"id\":\"9zj61whbdl319sjgz098lpys5cngmtro_full_true_false\",\"imp\":[{\"id\":\"imp1\",\"banner\":{\"wmax\":300," +
      "\"hmax\":100,\"wmin\":200,\"hmin\":50,\"id\":\"banner1\",\"btype\":[3],\"battr\":[12],\"pos\":1," +
      "\"mimes\":[\"image/gif\"],\"topframe\":1,\"expdir\":[2],\"api\":[3],\"ext\":{\"test1\":\"data1\"}}," +
      "\"displaymanager\":\"dm1\",\"displaymanagerver\":\"1.0\",\"instl\":0,\"tagid\":\"tag1\",\"bidfloor\":100.0," +
      "\"bidfloorcur\":\"USD\",\"secure\":0,\"iframebuster\":[\"buster1\"],\"pmp\":{\"private_auction\":0," +
   ...
   static final String REQUEST__FULL__ROOT___OBJECT =
      ...
      "\"playbackmethod\":[3],\"delivery\":[1],\"pos\":1,\"companionad\":[{\"w\":100,\"h\":50,\"id\":\"compad1\"}]," +
      "\"companionad\":{\"banner\":[{\"w\":110,\"h\":60,\"id\":\"compad2\"}]},\"api\":[2],\"companiontype\":[2]," +
      "\"ext\":{\"test1\":\"data1\"}}},{\"id\":\"imp3\",\"native\":{\"request\":\"{\\\"native\\\":{" +
      "\\\"ver\\\":\\\"1\\\",\\\"layout\\\":2,\\\"adunit\\\":4,\\\"plcmtcnt\\\":1,\\\"seq\\\":1}}\",\"ver\":\"1.0\"," +
      "\"api\":[3],\"battr\":[12],\"ext\":{\"test1\":\"data1\"}},\"ext\":{\"test1\":\"data1\"}}],\"device\":{" +
      "\"ua\":\"Chrome\",\"geo\":{\"lat\":90.0,\"lon\":45.0,\"type\":1,\"country\":\"USA\",\"region\":\"New York\"," +
      ...
      "\"didmd5\":\"4321\",\"dpidsha1\":\"5678\",\"dpidmd5\":\"8765\",\"macsha1\":\"abc\",\"macmd5\":\"xyz\",\"ext\":{" +
      "\"test1\":\"data1\"}},\"user\":{\"id\":\"user1\",\"buyeruid\":\"Picard\",\"yob\":1973,\"gender\":\"M\"," +
      ...
      "\"tmax\":100,\"wseat\":[\"seat1\"],\"allimps\":0,\"cur\":[\"USD\"],\"bcat\":[\"IAB11\",\"IAB11-4\"]," +
   ...
   private static OpenRtb.NativeRequest.Builder generateNativeRequest() throws IOException
   {
      ...
      nativeRequest.setVer("1")
                   ...
                   .setPlcmtcnt(1)
                   .setSeq(1);
      //      return newJsonFactory().newNativeWriter().writeNativeRequest(nativeRequest.build());
